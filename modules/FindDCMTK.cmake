...
foreach(lib
  ...
  if(DCMTK_${lib}_LIBRARY)
    list(APPEND LOCAL_DCMTK_LIBRARIES ${DCMTK_${lib}_LIBRARY})
  endif()
...
set(DCMTK_INCLUDE_DIR ${LOCAL_DCMTK_INCLUDE_DIRS})
set(DCMTK_INCLUDE_DIRS ${LOCAL_DCMTK_INCLUDE_DIRS})
set(DCMTK_LIBRARIES ${LOCAL_DCMTK_LIBRARIES})
